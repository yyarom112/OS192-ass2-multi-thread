...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 20 1f 00 00       	push   $0x1f20
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d 20 1f 00 00 63 	cmpb   $0x63,0x1f20
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 21 1f 00 00 64 	cmpb   $0x64,0x1f21
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 23 1f 00 00       	push   $0x1f23
      ec:	68 b1 17 00 00       	push   $0x17b1
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     10e:	68 08 17 00 00       	push   $0x1708
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 a5 17 00 00       	push   $0x17a5
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 c0 17 00 00 	jmp    *0x17c0(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 12 17 00 00       	push   $0x1712
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 22 17 00 00       	push   $0x1722
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 0b 17 00 00       	push   $0x170b
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 32 17 00 00       	push   $0x1732
     ...
     2d8:	68 37 17 00 00       	push   $0x1737
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 32 17 00 00       	push   $0x1732
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 fc 1e 00 00       	push   $0x1efc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 fc 1e 00 00       	push   $0x1efc
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 f4 1e 00 00       	push   $0x1ef4
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 fc 1e 00 00       	push   $0x1efc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 fc 1e 00 00       	push   $0x1efc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 59 17 00 00       	push   $0x1759
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 3c 17 00 00       	push   $0x173c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 5c 17 00 00       	push   $0x175c
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 73 17 00 00       	push   $0x1773
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 65 17 00 00       	push   $0x1765
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 5e 17 00 00       	push   $0x175e
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 78 17 00 00       	push   $0x1778
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 7a 17 00 00       	push   $0x177a
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 76 17 00 00       	push   $0x1776
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 5c 17 00 00       	push   $0x175c
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 98 17 00 00       	push   $0x1798
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 d8 17 00 00 	jmp    *0x17d8(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 21 17 00 00       	push   $0x1721
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 9a 17 00 00       	push   $0x179a
     aa6:	6a 02                	push   $0x2
     aa8:	e8 f3 03 00 00       	call   ea0 <printf>
    panic("syntax");
     aad:	c7 04 24 5e 17 00 00 	movl   $0x175e,(%esp)
     ...
     e09:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e37:	f7 f1                	div    %ecx
     e39:	0f b6 92 f8 17 00 00 	movzbl 0x17f8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1054:	e9 8f fe ff ff       	jmp    ee8 <printf+0x48>
          s = "(null)";
    1059:	bb f0 17 00 00       	mov    $0x17f0,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1071:	a1 84 1f 00 00       	mov    0x1f84,%eax
{
  ...
  freep = p;
    10af:	a3 84 1f 00 00       	mov    %eax,0x1f84
}
    10b4:	5b                   	pop    %ebx
    10b5:	5e                   	pop    %esi
    10b6:	5f                   	pop    %edi
    ...
    10c6:	72 ce                	jb     1096 <free+0x26>
{
  ...
  freep = p;
    10ea:	a3 84 1f 00 00       	mov    %eax,0x1f84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    110c:	8b 15 84 1f 00 00    	mov    0x1f84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1151:	39 05 84 1f 00 00    	cmp    %eax,0x1f84
  ...
  return freep;
    117b:	8b 15 84 1f 00 00    	mov    0x1f84,%edx
    ...
    11a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    11a7:	89 15 84 1f 00 00    	mov    %edx,0x1f84
}
    ...
    base.s.ptr = freep = prevp = &base;
    11c0:	c7 05 84 1f 00 00 88 	movl   $0x1f88,0x1f84
    11c7:	1f 00 00 
    11ca:	c7 05 88 1f 00 00 88 	movl   $0x1f88,0x1f88
    11d1:	1f 00 00 
    base.s.size = 0;
    11d4:	b8 88 1f 00 00       	mov    $0x1f88,%eax
    11d9:	c7 05 8c 1f 00 00 00 	movl   $0x0,0x1f8c
    11e0:	00 00 00 
...
int powordepth(int exp) {
    ...
    120d:	74 08                	je     1217 <powordepth+0x17>
    120f:	90                   	nop
        output *= init;
    1210:	01 c0                	add    %eax,%eax
    while (exp != 0) {
    1212:	83 ea 01             	sub    $0x1,%edx
    1215:	75 f9                	jne    1210 <powordepth+0x10>
        exp--;
    }
    return output;
}
...
struct trnmnt_tree *trnmnt_tree_alloc(int depth) {
    ...
    1229:	6a 10                	push   $0x10
    122b:	e8 d0 fe ff ff       	call   1100 <malloc>
    ...
    123b:	83 f8 05             	cmp    $0x5,%eax
    123e:	0f 87 f6 00 00 00    	ja     133a <trnmnt_tree_alloc+0x11a>
    1244:	8b 45 08             	mov    0x8(%ebp),%eax
    int output = 1;
    1247:	bf 01 00 00 00       	mov    $0x1,%edi
    124c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        output *= init;
    1250:	01 ff                	add    %edi,%edi
    while (exp != 0) {
    1252:	83 e8 01             	sub    $0x1,%eax
    1255:	75 f9                	jne    1250 <trnmnt_tree_alloc+0x30>
    1257:	89 45 dc             	mov    %eax,-0x24(%ebp)
        return 0;
    int treeSize = powordepth(depth) - 1;
    125a:	8d 47 ff             	lea    -0x1(%edi),%eax
    125d:	89 45 e4             	mov    %eax,-0x1c(%ebp)

    //depth field
    output->depth = depth;
    1260:	8b 45 08             	mov    0x8(%ebp),%eax
    1263:	89 46 0c             	mov    %eax,0xc(%esi)

    //init lock field
    if ((output->Lock = kthread_mutex_alloc()) == -1) {
    1266:	e8 67 fb ff ff       	call   dd2 <kthread_mutex_alloc>
    126b:	83 f8 ff             	cmp    $0xffffffff,%eax
    126e:	89 06                	mov    %eax,(%esi)
    1270:	0f 84 34 01 00 00    	je     13aa <trnmnt_tree_alloc+0x18a>
        free(output);
        return 0;
    }
    ...
    127f:	50                   	push   %eax
    1280:	89 45 e0             	mov    %eax,-0x20(%ebp)
    1283:	e8 78 fe ff ff       	call   1100 <malloc>
    1288:	83 c4 10             	add    $0x10,%esp
    128b:	85 c0                	test   %eax,%eax
    128d:	89 46 04             	mov    %eax,0x4(%esi)
    1290:	0f 84 14 01 00 00    	je     13aa <trnmnt_tree_alloc+0x18a>
        free(output);
        return 0;
    }
    for (i = 0; i < treeSize; i++){
    1296:	31 db                	xor    %ebx,%ebx
    1298:	eb 09                	jmp    12a3 <trnmnt_tree_alloc+0x83>
    129a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    12a0:	8b 46 04             	mov    0x4(%esi),%eax
        output->mutextree[i] = kthread_mutex_alloc();
    12a3:	8d 3c 98             	lea    (%eax,%ebx,4),%edi
    for (i = 0; i < treeSize; i++){
    12a6:	83 c3 01             	add    $0x1,%ebx
        output->mutextree[i] = kthread_mutex_alloc();
    12a9:	e8 24 fb ff ff       	call   dd2 <kthread_mutex_alloc>
    for (i = 0; i < treeSize; i++){
    12ae:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
        output->mutextree[i] = kthread_mutex_alloc();
    12b1:	89 07                	mov    %eax,(%edi)
    for (i = 0; i < treeSize; i++){
    12b3:	75 eb                	jne    12a0 <trnmnt_tree_alloc+0x80>
    ...
    12b5:	8b 4e 04             	mov    0x4(%esi),%ecx
    12b8:	8b 55 e0             	mov    -0x20(%ebp),%edx
            initCheck = 1;
    12bb:	bf 01 00 00 00       	mov    $0x1,%edi
        if (output->mutextree[i] == -1)
    12c0:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    12c3:	89 c8                	mov    %ecx,%eax
    12c5:	01 ca                	add    %ecx,%edx
    int initCheck = 0;
    12c7:	31 c9                	xor    %ecx,%ecx
    12c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            initCheck = 1;
    12d0:	83 38 ff             	cmpl   $0xffffffff,(%eax)
    12d3:	0f 44 cf             	cmove  %edi,%ecx
    12d6:	83 c0 04             	add    $0x4,%eax
    for (int i = 0; i < treeSize; i++) {
    12d9:	39 d0                	cmp    %edx,%eax
    12db:	75 f3                	jne    12d0 <trnmnt_tree_alloc+0xb0>
    }
    if (initCheck) {
    12dd:	85 c9                	test   %ecx,%ecx
    12df:	8b 7d 08             	mov    0x8(%ebp),%edi
    12e2:	b8 01 00 00 00       	mov    $0x1,%eax
    12e7:	0f 85 9b 00 00 00    	jne    1388 <trnmnt_tree_alloc+0x168>
    12ed:	8d 76 00             	lea    0x0(%esi),%esi
        output *= init;
    12f0:	01 c0                	add    %eax,%eax
    while (exp != 0) {
    12f2:	83 ef 01             	sub    $0x1,%edi
    12f5:	75 f9                	jne    12f0 <trnmnt_tree_alloc+0xd0>
    }
    ...
    12fd:	50                   	push   %eax
    12fe:	e8 fd fd ff ff       	call   1100 <malloc>
    1303:	83 c4 10             	add    $0x10,%esp
    1306:	85 c0                	test   %eax,%eax
    1308:	89 46 08             	mov    %eax,0x8(%esi)
    130b:	8b 4d 08             	mov    0x8(%ebp),%ecx
    130e:	74 36                	je     1346 <trnmnt_tree_alloc+0x126>
    ...
    1319:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        output *= init;
    1320:	01 d2                	add    %edx,%edx
    while (exp != 0) {
    1322:	83 e8 01             	sub    $0x1,%eax
    1325:	75 f9                	jne    1320 <trnmnt_tree_alloc+0x100>
    ...
    1327:	39 d7                	cmp    %edx,%edi
    1329:	7d 11                	jge    133c <trnmnt_tree_alloc+0x11c>
        output->threadMap[i] = -1;
    132b:	8b 46 08             	mov    0x8(%esi),%eax
    132e:	c7 04 b8 ff ff ff ff 	movl   $0xffffffff,(%eax,%edi,4)
    for (i = 0; i < powordepth(depth); i++)
    1335:	83 c7 01             	add    $0x1,%edi
    1338:	eb d6                	jmp    1310 <trnmnt_tree_alloc+0xf0>
        return 0;
    133a:	31 f6                	xor    %esi,%esi
    ...
    1346:	8b 46 04             	mov    0x4(%esi),%eax
    1349:	83 ec 0c             	sub    $0xc,%esp
    134c:	ff 34 b8             	pushl  (%eax,%edi,4)
        for (int i = 0; i < treeSize; i++) {
    134f:	83 c7 01             	add    $0x1,%edi
            kthread_mutex_dealloc(output->mutextree[i]);
    1352:	e8 83 fa ff ff       	call   dda <kthread_mutex_dealloc>
        for (int i = 0; i < treeSize; i++) {
    1357:	83 c4 10             	add    $0x10,%esp
    135a:	39 df                	cmp    %ebx,%edi
    135c:	75 e8                	jne    1346 <trnmnt_tree_alloc+0x126>
        kthread_mutex_dealloc(output->Lock);
    135e:	83 ec 0c             	sub    $0xc,%esp
    1361:	ff 36                	pushl  (%esi)
    1363:	e8 72 fa ff ff       	call   dda <kthread_mutex_dealloc>
        free(output->mutextree);
    1368:	58                   	pop    %eax
    1369:	ff 76 04             	pushl  0x4(%esi)
    136c:	e8 ff fc ff ff       	call   1070 <free>
        free(output);
    1371:	89 34 24             	mov    %esi,(%esp)
        return 0;
    1374:	31 f6                	xor    %esi,%esi
        free(output);
    1376:	e8 f5 fc ff ff       	call   1070 <free>
        return 0;
    137b:	83 c4 10             	add    $0x10,%esp
}
    137e:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1381:	89 f0                	mov    %esi,%eax
    1383:	5b                   	pop    %ebx
    1384:	5e                   	pop    %esi
    1385:	5f                   	pop    %edi
    1386:	5d                   	pop    %ebp
    1387:	c3                   	ret    
    1388:	8b 7d dc             	mov    -0x24(%ebp),%edi
    138b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    138e:	eb 03                	jmp    1393 <trnmnt_tree_alloc+0x173>
    1390:	8b 46 04             	mov    0x4(%esi),%eax
            kthread_mutex_dealloc(output->mutextree[i]);
    1393:	83 ec 0c             	sub    $0xc,%esp
    1396:	ff 34 b8             	pushl  (%eax,%edi,4)
        for (int i = 0; i < treeSize; i++) {
    1399:	83 c7 01             	add    $0x1,%edi
            kthread_mutex_dealloc(output->mutextree[i]);
    139c:	e8 39 fa ff ff       	call   dda <kthread_mutex_dealloc>
        for (int i = 0; i < treeSize; i++) {
    13a1:	83 c4 10             	add    $0x10,%esp
    13a4:	39 df                	cmp    %ebx,%edi
    13a6:	75 e8                	jne    1390 <trnmnt_tree_alloc+0x170>
    13a8:	eb b4                	jmp    135e <trnmnt_tree_alloc+0x13e>
        free(output);
    ...
    13ae:	31 f6                	xor    %esi,%esi
        free(output);
    13b0:	e8 bb fc ff ff       	call   1070 <free>
        return 0;
    13b5:	83 c4 10             	add    $0x10,%esp
    13b8:	eb 82                	jmp    133c <trnmnt_tree_alloc+0x11c>
    13ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000013c0 <trnmnt_tree_dealloc>:
...
int trnmnt_tree_dealloc(struct trnmnt_tree *tree) {
    ...
    13c9:	8b 75 08             	mov    0x8(%ebp),%esi
    int i;
    kthread_mutex_lock(tree->Lock);
    13cc:	ff 36                	pushl  (%esi)
    13ce:	e8 0f fa ff ff       	call   de2 <kthread_mutex_lock>
    int treeSize = powordepth(tree->depth) - 1;
    13d3:	8b 7e 0c             	mov    0xc(%esi),%edi
    while (exp != 0) {
    13d6:	83 c4 10             	add    $0x10,%esp
    13d9:	85 ff                	test   %edi,%edi
    13db:	0f 84 0b 01 00 00    	je     14ec <trnmnt_tree_dealloc+0x12c>
    13e1:	89 f8                	mov    %edi,%eax
    int output = 1;
    13e3:	bb 01 00 00 00       	mov    $0x1,%ebx
    13e8:	90                   	nop
    13e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        output *= init;
    13f0:	01 db                	add    %ebx,%ebx
    while (exp != 0) {
    13f2:	83 e8 01             	sub    $0x1,%eax
    13f5:	75 f9                	jne    13f0 <trnmnt_tree_dealloc+0x30>
    13f7:	83 eb 01             	sub    $0x1,%ebx
    for (i = 0; i < powordepth(tree->depth); i++) {
    13fa:	31 c9                	xor    %ecx,%ecx
    while (exp != 0) {
    13fc:	85 ff                	test   %edi,%edi
    13fe:	74 2f                	je     142f <trnmnt_tree_dealloc+0x6f>
    1400:	89 f8                	mov    %edi,%eax
    int output = 1;
    1402:	ba 01 00 00 00       	mov    $0x1,%edx
    1407:	89 f6                	mov    %esi,%esi
    1409:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        output *= init;
    1410:	01 d2                	add    %edx,%edx
    while (exp != 0) {
    1412:	83 e8 01             	sub    $0x1,%eax
    1415:	75 f9                	jne    1410 <trnmnt_tree_dealloc+0x50>
    for (i = 0; i < powordepth(tree->depth); i++) {
    1417:	39 d1                	cmp    %edx,%ecx
    1419:	7d 25                	jge    1440 <trnmnt_tree_dealloc+0x80>
        if (tree->threadMap[i] != -1){
    141b:	8b 46 08             	mov    0x8(%esi),%eax
    141e:	83 3c 88 ff          	cmpl   $0xffffffff,(%eax,%ecx,4)
    1422:	0f 85 a8 00 00 00    	jne    14d0 <trnmnt_tree_dealloc+0x110>
    for (i = 0; i < powordepth(tree->depth); i++) {
    1428:	83 c1 01             	add    $0x1,%ecx
    while (exp != 0) {
    142b:	85 ff                	test   %edi,%edi
    142d:	75 d1                	jne    1400 <trnmnt_tree_dealloc+0x40>
    int output = 1;
    142f:	ba 01 00 00 00       	mov    $0x1,%edx
    for (i = 0; i < powordepth(tree->depth); i++) {
    1434:	39 d1                	cmp    %edx,%ecx
    1436:	7c e3                	jl     141b <trnmnt_tree_dealloc+0x5b>
    1438:	90                   	nop
    ...
    for (int i = 0; i < treeSize; i++) {
    1440:	85 db                	test   %ebx,%ebx
    1442:	74 46                	je     148a <trnmnt_tree_dealloc+0xca>
    1444:	31 ff                	xor    %edi,%edi
    1446:	eb 0f                	jmp    1457 <trnmnt_tree_dealloc+0x97>
    1448:	90                   	nop
    1449:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1450:	83 c7 01             	add    $0x1,%edi
    1453:	39 fb                	cmp    %edi,%ebx
    1455:	74 33                	je     148a <trnmnt_tree_dealloc+0xca>
        if (kthread_mutex_dealloc(tree->mutextree[i]) == -1){
    1457:	8b 46 04             	mov    0x4(%esi),%eax
    145a:	83 ec 0c             	sub    $0xc,%esp
    145d:	ff 34 b8             	pushl  (%eax,%edi,4)
    1460:	e8 75 f9 ff ff       	call   dda <kthread_mutex_dealloc>
    1465:	83 c4 10             	add    $0x10,%esp
    1468:	83 f8 ff             	cmp    $0xffffffff,%eax
    146b:	75 e3                	jne    1450 <trnmnt_tree_dealloc+0x90>
            kthread_mutex_unlock(tree->Lock);
    146d:	83 ec 0c             	sub    $0xc,%esp
    1470:	ff 36                	pushl  (%esi)
    1472:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1475:	e8 70 f9 ff ff       	call   dea <kthread_mutex_unlock>
            return -1;
    ...
    148d:	ff 36                	pushl  (%esi)
    148f:	e8 56 f9 ff ff       	call   dea <kthread_mutex_unlock>
    kthread_mutex_dealloc(tree->Lock);
    1494:	58                   	pop    %eax
    1495:	ff 36                	pushl  (%esi)
    1497:	e8 3e f9 ff ff       	call   dda <kthread_mutex_dealloc>
    free(tree->threadMap);
    149c:	5a                   	pop    %edx
    149d:	ff 76 08             	pushl  0x8(%esi)
    14a0:	e8 cb fb ff ff       	call   1070 <free>
    free(tree->mutextree);
    14a5:	59                   	pop    %ecx
    14a6:	ff 76 04             	pushl  0x4(%esi)
    14a9:	e8 c2 fb ff ff       	call   1070 <free>
    free(tree);
    14ae:	89 34 24             	mov    %esi,(%esp)
    14b1:	e8 ba fb ff ff       	call   1070 <free>
    tree->depth = 0;
    14b6:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
    return 0;
    ...
    14d3:	ff 36                	pushl  (%esi)
    14d5:	e8 10 f9 ff ff       	call   dea <kthread_mutex_unlock>
            return -1;
    14da:	83 c4 10             	add    $0x10,%esp
}
    14dd:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return -1;
    14e0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
}
    ...
    14eb:	c3                   	ret    
    while (exp != 0) {
    14ec:	31 db                	xor    %ebx,%ebx
    14ee:	e9 07 ff ff ff       	jmp    13fa <trnmnt_tree_dealloc+0x3a>
    14f3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    14f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001500 <trnmnt_tree_acquire>:
...
int trnmnt_tree_acquire(trnmnt_tree *tree, int ID) {
    ...
    1509:	8b 7d 0c             	mov    0xc(%ebp),%edi
    150c:	8b 75 08             	mov    0x8(%ebp),%esi
    int treePosition, fatherPosition = -1;
    if (ID < 0 || tree == 0 || ID > (powordepth(tree->depth) - 1)) {
    150f:	85 ff                	test   %edi,%edi
    1511:	0f 88 d1 00 00 00    	js     15e8 <trnmnt_tree_acquire+0xe8>
    1517:	85 f6                	test   %esi,%esi
    1519:	0f 84 c9 00 00 00    	je     15e8 <trnmnt_tree_acquire+0xe8>
    151f:	8b 46 0c             	mov    0xc(%esi),%eax
    int output = 1;
    1522:	ba 01 00 00 00       	mov    $0x1,%edx
    while (exp != 0) {
    1527:	85 c0                	test   %eax,%eax
    1529:	74 0c                	je     1537 <trnmnt_tree_acquire+0x37>
    152b:	90                   	nop
    152c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        output *= init;
    1530:	01 d2                	add    %edx,%edx
    while (exp != 0) {
    1532:	83 e8 01             	sub    $0x1,%eax
    1535:	75 f9                	jne    1530 <trnmnt_tree_acquire+0x30>
    if (ID < 0 || tree == 0 || ID > (powordepth(tree->depth) - 1)) {
    1537:	39 d7                	cmp    %edx,%edi
    1539:	0f 8d a9 00 00 00    	jge    15e8 <trnmnt_tree_acquire+0xe8>
        return -1;
    }
    kthread_mutex_lock(tree->Lock);
    153f:	83 ec 0c             	sub    $0xc,%esp
    1542:	ff 36                	pushl  (%esi)
    1544:	e8 99 f8 ff ff       	call   de2 <kthread_mutex_lock>

    if (tree->threadMap[ID] != -1) {
    1549:	8b 46 08             	mov    0x8(%esi),%eax
    154c:	83 c4 10             	add    $0x10,%esp
    154f:	8d 1c b8             	lea    (%eax,%edi,4),%ebx
    1552:	83 3b ff             	cmpl   $0xffffffff,(%ebx)
    1555:	0f 85 94 00 00 00    	jne    15ef <trnmnt_tree_acquire+0xef>
        kthread_mutex_unlock(tree->Lock);
        return -1;
    }
    tree->threadMap[ID] = kthread_id();
    155b:	e8 5a f8 ff ff       	call   dba <kthread_id>
    kthread_mutex_unlock(tree->Lock);
    1560:	83 ec 0c             	sub    $0xc,%esp
    tree->threadMap[ID] = kthread_id();
    1563:	89 03                	mov    %eax,(%ebx)
    kthread_mutex_unlock(tree->Lock);
    1565:	ff 36                	pushl  (%esi)
    1567:	e8 7e f8 ff ff       	call   dea <kthread_mutex_unlock>
    treePosition = (powordepth(tree->depth) - 1) + ID;
    156c:	8b 46 0c             	mov    0xc(%esi),%eax
    while (exp != 0) {
    156f:	83 c4 10             	add    $0x10,%esp
    1572:	85 c0                	test   %eax,%eax
    1574:	74 5a                	je     15d0 <trnmnt_tree_acquire+0xd0>
    int output = 1;
    1576:	ba 01 00 00 00       	mov    $0x1,%edx
    157b:	90                   	nop
    157c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        output *= init;
    1580:	01 d2                	add    %edx,%edx
    while (exp != 0) {
    1582:	83 e8 01             	sub    $0x1,%eax
    1585:	75 f9                	jne    1580 <trnmnt_tree_acquire+0x80>
    fatherPosition = (treePosition - 1) / 2;
    1587:	8d 44 3a fe          	lea    -0x2(%edx,%edi,1),%eax
    158b:	89 c3                	mov    %eax,%ebx
    158d:	c1 eb 1f             	shr    $0x1f,%ebx
    1590:	01 c3                	add    %eax,%ebx
    1592:	d1 fb                	sar    %ebx
    1594:	eb 0c                	jmp    15a2 <trnmnt_tree_acquire+0xa2>
    ...
    while (treePosition != 0) {
        ...
        fatherPosition = (treePosition - 1) / 2;
    15a0:	89 c3                	mov    %eax,%ebx
        kthread_mutex_lock(tree->mutextree[fatherPosition]);
    15a2:	8b 46 04             	mov    0x4(%esi),%eax
    15a5:	83 ec 0c             	sub    $0xc,%esp
    15a8:	ff 34 98             	pushl  (%eax,%ebx,4)
    15ab:	e8 32 f8 ff ff       	call   de2 <kthread_mutex_lock>
        fatherPosition = (treePosition - 1) / 2;
    15b0:	8d 53 ff             	lea    -0x1(%ebx),%edx
    while (treePosition != 0) {
    15b3:	83 c4 10             	add    $0x10,%esp
        fatherPosition = (treePosition - 1) / 2;
    15b6:	89 d0                	mov    %edx,%eax
    15b8:	c1 e8 1f             	shr    $0x1f,%eax
    15bb:	01 d0                	add    %edx,%eax
    15bd:	d1 f8                	sar    %eax
    while (treePosition != 0) {
    15bf:	85 db                	test   %ebx,%ebx
    15c1:	75 dd                	jne    15a0 <trnmnt_tree_acquire+0xa0>
    }
    return 0;
    15c3:	31 c0                	xor    %eax,%eax
}
    15c5:	8d 65 f4             	lea    -0xc(%ebp),%esp
    15c8:	5b                   	pop    %ebx
    15c9:	5e                   	pop    %esi
    15ca:	5f                   	pop    %edi
    15cb:	5d                   	pop    %ebp
    ...
    fatherPosition = (treePosition - 1) / 2;
    15d0:	8d 47 ff             	lea    -0x1(%edi),%eax
    15d3:	89 c3                	mov    %eax,%ebx
    15d5:	c1 eb 1f             	shr    $0x1f,%ebx
    15d8:	01 c3                	add    %eax,%ebx
    15da:	d1 fb                	sar    %ebx
    while (treePosition != 0) {
    15dc:	85 ff                	test   %edi,%edi
    15de:	74 e3                	je     15c3 <trnmnt_tree_acquire+0xc3>
    15e0:	eb c0                	jmp    15a2 <trnmnt_tree_acquire+0xa2>
    15e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        return -1;
    15e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    15ed:	eb d6                	jmp    15c5 <trnmnt_tree_acquire+0xc5>
        kthread_mutex_unlock(tree->Lock);
    15ef:	83 ec 0c             	sub    $0xc,%esp
    15f2:	ff 36                	pushl  (%esi)
    15f4:	e8 f1 f7 ff ff       	call   dea <kthread_mutex_unlock>
        return -1;
    15f9:	83 c4 10             	add    $0x10,%esp
    15fc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1601:	eb c2                	jmp    15c5 <trnmnt_tree_acquire+0xc5>
    1603:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    1609:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001610 <trnmnt_tree_release_rec>:
...
int trnmnt_tree_release_rec(struct trnmnt_tree *tree, int position) {
    1618:	8b 75 08             	mov    0x8(%ebp),%esi
    int fatherPosition = (position - 1) / 2;
    161b:	8d 50 ff             	lea    -0x1(%eax),%edx
    ...
    1629:	75 15                	jne    1640 <trnmnt_tree_release_rec+0x30>
    ...
    162b:	8b 46 04             	mov    0x4(%esi),%eax
    162e:	8b 04 98             	mov    (%eax,%ebx,4),%eax
    1631:	89 45 08             	mov    %eax,0x8(%ebp)
}
    1634:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1637:	5b                   	pop    %ebx
    1638:	5e                   	pop    %esi
    1639:	5d                   	pop    %ebp
    return kthread_mutex_unlock(tree->mutextree[fatherPosition]);
    163a:	e9 ab f7 ff ff       	jmp    dea <kthread_mutex_unlock>
    163f:	90                   	nop
        if (trnmnt_tree_release_rec(tree, fatherPosition) == -1){
    1640:	83 ec 08             	sub    $0x8,%esp
    1643:	50                   	push   %eax
    1644:	56                   	push   %esi
    1645:	e8 c6 ff ff ff       	call   1610 <trnmnt_tree_release_rec>
    164a:	83 c4 10             	add    $0x10,%esp
    164d:	83 f8 ff             	cmp    $0xffffffff,%eax
    1650:	75 d9                	jne    162b <trnmnt_tree_release_rec+0x1b>
}
    1652:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1655:	5b                   	pop    %ebx
    1656:	5e                   	pop    %esi
    1657:	5d                   	pop    %ebp
    1658:	c3                   	ret    
...
int trnmnt_tree_release(struct trnmnt_tree *tree, int ID) {
    ...
    166c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    kthread_mutex_lock(tree->Lock);
    166f:	ff 37                	pushl  (%edi)
    1671:	e8 6c f7 ff ff       	call   de2 <kthread_mutex_lock>
    if (tree->threadMap[ID] != kthread_id()) {
    1676:	8b 47 08             	mov    0x8(%edi),%eax
    1679:	8b 04 98             	mov    (%eax,%ebx,4),%eax
    167c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    167f:	e8 36 f7 ff ff       	call   dba <kthread_id>
    1684:	83 c4 10             	add    $0x10,%esp
    1687:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
    168a:	75 56                	jne    16e2 <trnmnt_tree_release+0x82>
        kthread_mutex_unlock(tree->Lock);
        return -1;
    }
    if(trnmnt_tree_release_rec(tree, (powordepth(tree->depth) - 1) + ID)==-1){
    168c:	8b 47 0c             	mov    0xc(%edi),%eax
    168f:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
    while (exp != 0) {
    1696:	85 c0                	test   %eax,%eax
    1698:	74 11                	je     16ab <trnmnt_tree_release+0x4b>
    int output = 1;
    169a:	b9 01 00 00 00       	mov    $0x1,%ecx
    169f:	90                   	nop
        output *= init;
    16a0:	01 c9                	add    %ecx,%ecx
    while (exp != 0) {
    16a2:	83 e8 01             	sub    $0x1,%eax
    16a5:	75 f9                	jne    16a0 <trnmnt_tree_release+0x40>
    16a7:	8d 5c 19 ff          	lea    -0x1(%ecx,%ebx,1),%ebx
    if(trnmnt_tree_release_rec(tree, (powordepth(tree->depth) - 1) + ID)==-1){
    16ab:	83 ec 08             	sub    $0x8,%esp
    16ae:	53                   	push   %ebx
    16af:	57                   	push   %edi
    16b0:	e8 5b ff ff ff       	call   1610 <trnmnt_tree_release_rec>
    16b5:	83 c4 10             	add    $0x10,%esp
    16b8:	83 f8 ff             	cmp    $0xffffffff,%eax
    16bb:	89 c3                	mov    %eax,%ebx
    16bd:	74 37                	je     16f6 <trnmnt_tree_release+0x96>
        kthread_mutex_unlock(tree->Lock);
        return -1;
    }
    tree->threadMap[ID] = -1;
    16bf:	8b 47 08             	mov    0x8(%edi),%eax
    kthread_mutex_unlock(tree->Lock);
    16c2:	83 ec 0c             	sub    $0xc,%esp
    return 0;
    16c5:	31 db                	xor    %ebx,%ebx
    tree->threadMap[ID] = -1;
    16c7:	c7 04 30 ff ff ff ff 	movl   $0xffffffff,(%eax,%esi,1)
    kthread_mutex_unlock(tree->Lock);
    16ce:	ff 37                	pushl  (%edi)
    16d0:	e8 15 f7 ff ff       	call   dea <kthread_mutex_unlock>
    return 0;
    16d5:	83 c4 10             	add    $0x10,%esp
}
    16d8:	8d 65 f4             	lea    -0xc(%ebp),%esp
    16db:	89 d8                	mov    %ebx,%eax
    16dd:	5b                   	pop    %ebx
    16de:	5e                   	pop    %esi
    16df:	5f                   	pop    %edi
    16e0:	5d                   	pop    %ebp
    ...
    16e5:	ff 37                	pushl  (%edi)
        return -1;
    16e7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
        kthread_mutex_unlock(tree->Lock);
    16ec:	e8 f9 f6 ff ff       	call   dea <kthread_mutex_unlock>
        return -1;
    16f1:	83 c4 10             	add    $0x10,%esp
    16f4:	eb e2                	jmp    16d8 <trnmnt_tree_release+0x78>
        kthread_mutex_unlock(tree->Lock);
    16f6:	83 ec 0c             	sub    $0xc,%esp
    16f9:	ff 37                	pushl  (%edi)
    16fb:	e8 ea f6 ff ff       	call   dea <kthread_mutex_unlock>
        return -1;
    1700:	83 c4 10             	add    $0x10,%esp
    1703:	eb d3                	jmp    16d8 <trnmnt_tree_release+0x78>
