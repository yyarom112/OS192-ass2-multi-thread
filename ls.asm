 ...
 679:	85 d2                	test   %edx,%edx
{
 ...
 6a7:	f7 f1                	div    %ecx
 6a9:	0f b6 92 cc 0f 00 00 	movzbl 0xfcc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 8c4:	e9 8f fe ff ff       	jmp    758 <printf+0x48>
          s = "(null)";
 8c9:	bb c2 0f 00 00       	mov    $0xfc2,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8e1:	a1 50 14 00 00       	mov    0x1450,%eax
{
 ...
 91d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 91f:	a3 50 14 00 00       	mov    %eax,0x1450
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
 ...
 936:	72 ce                	jb     906 <free+0x26>
{
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 50 14 00 00       	mov    %eax,0x1450
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 15 50 14 00 00    	mov    0x1450,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9bf:	73 47                	jae    a08 <malloc+0x98>
    ...
    if(p == freep)
 9c1:	39 05 50 14 00 00    	cmp    %eax,0x1450
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
  return freep;
 9eb:	8b 15 50 14 00 00    	mov    0x1450,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a17:	89 15 50 14 00 00    	mov    %edx,0x1450
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 50 14 00 00 54 	movl   $0x1454,0x1450
 a37:	14 00 00 
 a3a:	c7 05 54 14 00 00 54 	movl   $0x1454,0x1454
 a41:	14 00 00 
    base.s.size = 0;
 a44:	b8 54 14 00 00       	mov    $0x1454,%eax
 a49:	c7 05 58 14 00 00 00 	movl   $0x0,0x1458
 a50:	00 00 00 
